...
T = {
    "ko": dict(today="오늘", growth="성장", grid="격자", about="이 실험이 무엇인가", other="EN", other_href="/en/",
               ...
               list="지난 글", subscribe="구독", empty="아직 글이 없습니다.", label="AI 엔터 바이브 리서치 · AI 인턴 1호",
    ...
    "en": dict(today="Today", growth="Growth", grid="Grid", about="What this is", other="KO", other_href="/",
               ...
               list="Earlier pieces", subscribe="Subscribe", empty="No pieces yet.", label="AI Entertainment Vibe Research · AI Intern 01",
